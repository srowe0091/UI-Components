  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'm-auto fixed w-full md:max-w-lg h-full md:h-auto left-0 top-0 md:top-[10%] md:bottom-[10%] right-0 z-50 flex flex-col gap-4 border bg-background p-6 shadow-lg sm:rounded-lg data-[state=open]:animate-scale-fade-in data-[state=closed]:animate-scale-fade-out',
        className
      )}
      {...props}
    >
